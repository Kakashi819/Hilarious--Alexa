...
function tellJoke(joke){
    VoiceRSS.speech({
        key:'090107b903904eca9ee88b9050cf4841',
        src:joke,
        hl:'en-us',
        r:0,
        c:'mp3',
...
// should have disabled our button audio done playing 
audioElement.addEventListener('ended',buttonToggle);